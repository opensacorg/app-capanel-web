  ...
  return (
    ...
    >
      ...
      <Text style={bodyTextStyle}>
        We've received a request to reset the password for your {project_name} account. Choose a new
      ...
      <Text style={supportingTextStyle}>This link will expire in {valid_hours} hours.</Text>
      <Text style={supportingTextStyle}>
