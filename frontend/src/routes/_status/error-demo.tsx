...
const errorPages = [
	{ code: '400', name: 'Bad Request', icon: AlertTriangle, path: '/status/bad-request', color: 'text-yellow-500' },
	{ code: '401', name: 'Unauthorized', icon: ShieldOff, path: '/status/401', color: 'text-yellow-500' },
	{ code: '403', name: 'Forbidden', icon: ShieldOff, path: '/status/403', color: 'text-destructive' },
	{ code: '404', name: 'Not Found', icon: FileQuestion, path: '/status/404', color: 'text-destructive' },
	{ code: '408', name: 'Timeout', icon: AlertTriangle, path: '/status/timeout', color: 'text-yellow-500' },
	{ code: '409', name: 'Conflict', icon: AlertTriangle, path: '/status/conflict', color: 'text-yellow-500' },
	{ code: '410', name: 'Gone', icon: FileQuestion, path: '/status/gone', color: 'text-muted-foreground' },
	{ code: '415', name: 'Unsupported Media', icon: AlertTriangle, path: '/status/unsupported-media', color: 'text-destructive' },
	{ code: '423', name: 'Locked', icon: ShieldOff, path: '/status/locked', color: 'text-destructive' },
	{ code: '429', name: 'Rate Limited', icon: AlertTriangle, path: '/status/rate-limited', color: 'text-yellow-500' },
	{ code: '500', name: 'Server Error', icon: AlertOctagon, path: '/status/500', color: 'text-destructive' },
	{ code: '502', name: 'Bad Gateway', icon: Network, path: '/status/bad-gateway', color: 'text-destructive' },
	{ code: '503', name: 'Unavailable', icon: Network, path: '/status/503', color: 'text-yellow-500' },
	{ code: '504', name: 'Gateway Timeout', icon: Network, path: '/status/gateway-timeout', color: 'text-destructive' },
]
