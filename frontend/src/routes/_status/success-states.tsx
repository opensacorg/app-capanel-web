...
const successPages = [
	...
	{ name: 'Upgrade Success', icon: Crown, path: '/status/upgrade-success', color: 'text-green-500' },
	{ name: 'Password Changed', icon: KeyRound, path: '/status/password-changed', color: 'text-green-500' },
	...
	{ name: 'Device Verified', icon: Check, path: '/status/device-verified', color: 'text-green-500' },
	{ name: 'Export Ready', icon: FileDown, path: '/status/export-ready', color: 'text-green-500' },
	{ name: 'Import Complete', icon: FileUp, path: '/status/import-complete', color: 'text-green-500' },
	{ name: 'Backup Complete', icon: Database, path: '/status/backup-complete', color: 'text-green-500' },
	{ name: 'API Key Created', icon: Key, path: '/status/api-key-created', color: 'text-green-500' },
	{ name: 'Webhook Configured', icon: Webhook, path: '/status/webhook-configured', color: 'text-green-500' },
]
