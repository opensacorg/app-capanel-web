...
const infoPages = [
	...
	{ name: 'Under Construction', icon: HardHat, path: '/status/under-construction', color: 'text-blue-500' },
	...
	{ name: 'Empty State', icon: FolderOpen, path: '/status/empty-state', color: 'text-muted-foreground' },
