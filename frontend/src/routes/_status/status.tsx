...
const services: ServiceStatus[] = [
	{ name: 'API Gateway', status: 'operational', icon: <Globe className="size-5" />, uptime: 99.99, responseTime: 45 },
	{ name: 'Database', status: 'operational', icon: <Database className="size-5" />, uptime: 99.95, responseTime: 12 },
	{ name: 'Authentication', status: 'operational', icon: <Shield className="size-5" />, uptime: 99.98, responseTime: 89 },
	{ name: 'Web Servers', status: 'operational', icon: <Server className="size-5" />, uptime: 99.97, responseTime: 23 },
	{ name: 'CDN', status: 'degraded', icon: <Zap className="size-5" />, uptime: 99.5, responseTime: 156 },
	{ name: 'Background Jobs', status: 'operational', icon: <Activity className="size-5" />, uptime: 99.9, responseTime: 34 },
]
							...
							<div className="flex items-center justify-between py-3">
								...
								<div className="flex items-center gap-3">
									...
									<Badge variant={getStatusBadgeVariant(service.status)}>
										<span className={`mr-1.5 size-2 rounded-full ${getStatusColor(service.status)}`} />
